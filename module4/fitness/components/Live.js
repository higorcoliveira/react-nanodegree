...
export default class Live extends Component {
  state = {
    coords: null, // colocando null ele gera erro de 'is not an object'
    status: 'undetermined', // null ele nao carrega a tela de pedir pela permissão
    direction: '',
    bounceValue: new Animated.Value(1),
  }

  // Estava quebrando a funcionalidade
  // componentDidMount () {
  ...
  setLocation = () => {
    Location.watchPositionAsync({
      ...
      // Anima de acordo com a posição capturada pelo gps
